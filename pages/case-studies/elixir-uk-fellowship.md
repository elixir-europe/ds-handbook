---
title: "Data Stewardship Fellowship"
layout: case-study
type: Case Study

description: A national fellowship that funded 24 Data Steward Fellows across 17 UK institutions to grow local FAIR data capacity and seeded a professional pathway for data stewards.

contributors: [Xenia Perez Sitja]
page_id: elixir-uk-fellowship

# Context card -----------------------------------------------------------
lead_org: "University of Bradford & Cardiff University / ELIXIR-UK"
country: UK
partners:
  - Earlham Institute
...
external_url: https://elixiruknode.org/activities/fellowship/
external_url_label: Visit the Fellowship programme page

# Lead quote at the top of the page --------------------------------------
lead_quote: 
...
Funding *people* with a meaningful honorarium – not just events or materials – was a great move but it required a lot of admin burden. While useful for more junior Fellows, the most senior ones did not find a direct benefit.
The badge of recognition and cohort gave Fellows something to stand on when negotiating internally for time and recognition.
The Train-the-Trainer baseline plus monthly community calls meant Fellows weren't isolated; they had a peer group to compare notes with. And bundling three things (people + materials + network) under one grant let each part reinforce the others.

{% include callout.html type="magpie" content="Fund people, not events – but expect admin burden, and don't assume the honorarium reads the same to a senior Fellow as it does to a junior one." %}
