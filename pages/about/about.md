...
{% include callout.html type="magpie" content="If you're brand new to RDM, start with the [RDMkit Data Steward page](https://rdmkit.elixir-europe.org/data_steward) for the role definition. Come back here when you're ready to actually do it." %}

## Meet the magpie

You'll see this little bird around. They're the handbook's guide – a magpie, the steward's spirit animal.

<aside class="margin-note">Magpies in folklore: clever, curious, careful collectors of shiny things.</aside>
...
### 🪶 [Signposts](/guidance) – practical guidance
...
### 🪶 [Campfires](/case-studies) – case studies
...
### 🪶 [Waypoints](/maturity-model) – maturity indicators
...
{% include callout.html type="tip" content="If you spot something useful, hit **add to the magpie's nest** under the page title. The magpie will keep it for you (in your browser) and you can print the lot as a PDF later." %}
...
- **For researchers.** If your question is *"how should I manage my own research data?"*, you want [RDMkit](https://rdmkit.elixir-europe.org/) instead.
- **A registry of tools, training, or standards.** Those live in [TeSS](https://tess.elixir-europe.org/), [FAIRsharing](https://fairsharing.org/), [FAIR Cookbook](https://faircookbook.elixir-europe.org/), and [DSW](https://ds-wizard.org/). We point at them when relevant; we don't replace them.
...
Content is published under a [CC-BY 4.0 licence](https://creativecommons.org/licenses/by/4.0/) – reuse it, remix it, share it, just credit us. The site is built on the [ELIXIR Toolkit Theme](https://elixir-belgium.github.io/elixir-toolkit-theme/) ([MIT licence](https://opensource.org/license/mit)).
